...
struct RouterDestinationDecoder: Decodable
{
    ...
    init(from decoder: Decoder) throws
    {
        ...
        guard let types = decoder.userInfo[.routerDestinationTypes] as? [any RouterDestination.Type]
        else
        {
            throw DecodingError.dataCorruptedError(in: container, debugDescription: "No router destination types defined")
        }
